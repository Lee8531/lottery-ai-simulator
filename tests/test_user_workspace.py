...
from lottery_sim.user_workspace import normalize_username, workspace_for_user
...
class UserWorkspaceTests(unittest.TestCase):
    ...
    def test_workspace_for_user_creates_private_directories(self):
        with _temp_dir() as tmp:
            ...
            self.assertTrue(workspace.recommendation_dir.is_dir())
            self.assertTrue(workspace.model_dir.is_dir())
